...
function wpb_adding_scripts() {
	...
	wp_enqueue_script('rr_masonry', get_template_directory_uri() . '/js/masonry.pkgd.min.js', array('jquery'),'1.0.0', true);	
	wp_enqueue_script('rr_lightbox_gallery', get_template_directory_uri() . '/js/min/lightbox_gallery-min.js', array('jquery'),'1.0.0', true);	
}
